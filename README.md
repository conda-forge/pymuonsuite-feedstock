...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymuonsuite-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14760&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymuonsuite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymuonsuite` can be installed with:

```
conda install pymuonsuite
```

It is possible to list all of the versions of `pymuonsuite` available on your platform with:
